...
train_dir = "/Users/yogesh/pythoncode/datasets/3-Food dataset/small/train"
test_dir ="/Users/yogesh/pythoncode/datasets/3-Food dataset/small/test"
...
dense_layer = keras.layers.Dense(3,activation="softmax")
...
# Hyper para tunning ------------------------------------------
# build a CNN model (same as the tiny VGG)
conv_layer11 = keras.layers.Conv2D(filters=50,
                        kernel_size=3,
                        activation="relu",
                        strides=(1,1),
                        input_shape =(224,224,3))
conv_layer21 = keras.layers.Conv2D(filters=50,
                        kernel_size=3,
                        activation="relu")
maxpool_layer11 =keras.layers.MaxPool2D(pool_size=2,padding="valid")
conv_layer31 = keras.layers.Conv2D(filters=50,
                        kernel_size=3,
                        activation="relu")
conv_layer41 = keras.layers.Conv2D(filters=50,
                        kernel_size=3,
                        activation="relu")
maxpool_layer21 = keras.layers.MaxPool2D(2)
flatten_layer1 = keras.layers.Flatten()
dense_layer1 = keras.layers.Dense(3,activation="softmax")
...
# fit the model
model_history = model1.fit(train_data,
                    epochs=50,
...
# Make predictions
prediction = model1.predict(normalised_img)
